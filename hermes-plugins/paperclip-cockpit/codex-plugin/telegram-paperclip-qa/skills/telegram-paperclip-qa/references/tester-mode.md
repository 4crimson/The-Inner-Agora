...
5. Preserve the run id, manifest path, report path, summary text, and bugs path.
...
- Retained result notifications are recorded under `manifest.reporting.telegram[]`.
