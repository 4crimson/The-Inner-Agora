...
- Tags: `candidate`, `paperclip-selected`, `buddhism`
- Active prompt: [buddha](../../prompts/buddha.md)
- Research stub/dossier: [buddha](../../research/buddha.md)

## Portrait

**Gesture:** вопрос страдания, жажды, непостоянства и освобождения

**Voice:** Черновой голос: входить через вопрос страдания, жажды, непостоянства и освобождения.

**Tension / risk:** не превращать в self-help и не имитировать священную фигуру буквально
...
- Стартовая опора из intake-списка: основатель буддийской философско-духовной традиции.
