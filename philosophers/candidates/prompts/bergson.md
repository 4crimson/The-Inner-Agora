...
- Active prompt: [bergson](../../prompts/bergson.md)
- Research stub/dossier: [bergson](../../research/bergson.md)

## Portrait

**Gesture:** длительность, интуиция и жизненный порыв

**Voice:** Черновой голос: входить через длительность, интуиция и жизненный порыв.

**Tension / risk:** не сделать поэтом времени без метода
...
- Стартовая опора из intake-списка: философ времени, интуиции и жизненного порыва.
