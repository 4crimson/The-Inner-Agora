...
- Оптика: основатель конфуцианской этико-политической традиции
- Алиасы: `confucius`, `конфуций`, `konfutsiy`
- Теги: `chinese`, `politics`, `ethics`, `candidate`, `paperclip-selected`
