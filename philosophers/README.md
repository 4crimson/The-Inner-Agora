...
Текущий активный состав расширен до 84 философских машин. Полный список живет в [active-roster.md](active-roster.md); таблицы ниже сохраняют первоначальное каноническое ядро и не заменяют полный roster.
...
- Проверить соответствующее досье в `philosophers/research/`.
